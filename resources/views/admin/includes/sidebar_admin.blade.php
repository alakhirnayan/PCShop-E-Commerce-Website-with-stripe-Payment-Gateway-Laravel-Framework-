      ...
      <div class="panel-heading">Menu</div>
        <div class="list-group"> 
          ...
          <div class="panel-body">
              ...
              <a href="{{route('deliveredOrders')}}" class="list-group-item">Delivered</a>
          </div>
          </div>
          ...
          <div class="panel-body">
              ...
              <a href="{{ route('combo.index')}}" class="list-group-item">All Combo Product</a>
              <a href="{{ route('product.create')}}" class="list-group-item">Create Product</a>
              <a href="{{ route('combo.create')}}" class="list-group-item">Create Combo</a>
        </div>
    <div class="panel-footer"> </div>
</div>
