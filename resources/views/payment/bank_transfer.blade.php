...
<div class="container"> 
  ...
  <li class="breadcrumb-item active">CashOnDelivery</li>
</ol>
<div class="row">
<div class="col-md-8 ">
  <div class="panel panel-default">
    <div class="panel-heading">Bank Trasfer</div>
              ...
              <div class="alert alert-warning" style=" margin-bottom: 0px;">
               <div class="row">
                 <div class="col-md-5">
                  ...
                  <div class="col-md-7">
                      <b>
                        Sub Total:TK {{Cart::subtotal()}}<br>
                        Grand Total:TK {{Cart::total()}}</b>
                  </div>
               </div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
           <div class="panel-body">
              <div class="alert alert-info" style=" margin-bottom: 0px;">
                <p>Provide Cash</p>
                <h4>When Product in Hand</h4> 
                 <p>Software Engineering Group 2</p>
              </div>
            </div>
         </div>
         </div>
