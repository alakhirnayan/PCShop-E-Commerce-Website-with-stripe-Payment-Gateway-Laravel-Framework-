...
<div class="col-md-8 ">
  <div class="panel panel-default">
    ...
    <form action="{{route('paymentcardSubmitOrder')}}" method="post" id="payment-form">
     {{csrf_field()}}
           ...
           <div class="panel-body">
              <div class="alert alert-info" style=" margin-bottom: 0px;">
                This webside will make shopping easier for those persons who wants to buy or manage 
                           ...
                           computer components yet. We are working to develop your shopping experience better.</div>
        </div>
      </div>
     </div>
...
var stripe = Stripe('pk_test_rQUauDVJ0nXiSLt3sxty0bGl');
