   ...
   <div class="box location-map">
     <img src="{{asset('/images/'.$products->image)}}" class="img-responsive"></a>
          ...
          <div class="details col-md-6">
            ...
            <div class="action">
              <a href="{{route('addToCart',$products->id)}}" class="add-to-cart btn btn-default" type="button">add to cart</a>
                            ...
                            <div class="col-item">
                                ...
                                <div class="info">
                                    ...
                                    <div class="separator clear-left">
                                        ...
                                        <p class="btn-details">
                                            <i class="fa fa-list"></i><a href="{{route('proinfo',$pr->id)}}" class="hidden-sm">More details</a></p>
                                    </div>
                                    <div class="clearfix">
                                    </div>
                                </div>
